...
function play(){
    ...
    while(player1_score<2 && player2_score<2){
        const {player1_sign,player2_sign,turn_winner} = get_turn_result();
    ...
    return {signs_history,score_history,winner};
...
function get_turn_result(){
    ...
    return {player1_sign,player2_sign,turn_winner};
...
module.exports = {play, get_random_sign, get_turn_winner, signs, PIERRE, FEUILLE, CISEAUX};